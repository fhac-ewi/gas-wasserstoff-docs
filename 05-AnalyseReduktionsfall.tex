...
\smallimage{Energiemix80.png}{Reduktionsfall 80 \% - Gesamtenergieverteilung bei 80 \% Reduktion}
...
\smallimage{KapazitätWind-80.png}{Reduktionsfall 80 \% - Installierte Leistung Windkraft-Offshore nach Clustern}
...
\smallimage{KapazitätPV-80.png}{Reduktionsfall 80 \% - Installierte Leistung Photovoltaik nach Clustern}
...
Die Kosten der Wind-Offshore Anlagen sind massiv gestiegen im Vergleich zur Anfang Szenario (22 Mrd. €), somit steigen die Gesamtsystemkosten in höchst Szenario, betragen 52 Mrd. Dies ist ersichtlich da, die Kosten für den Gas-Import sinken . Diese Steigerung ist auch wegen von verschiedene Speicherkapazitäten wobei die H\textsubscript{2} Salzkavernen zum Einsatz ab dem 85 \% Fall zur Speicherung von Wasserstoff.
