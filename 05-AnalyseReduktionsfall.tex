...
Die GuD-Kraftwerke mit Methan Verbrennung, als konventioneller Erzeuger, können nahezu vollständig die benötigte Flexibilität aufgrund des Einsatzes von erneuerbaren Energien im Energienetz bereitstellen. Der Energiebedarf von 627.282 GWh pro Jahr in Modell setzt sich aus der Stromnachfrage und der benötigten Energie für die Elektrolyse zur Deckung der Was-serstoffnachfrage zusammen. Lediglich 1,5 % der Nachfrage muss durch flexible Speichernut-zung gedeckt werden. Dies geschieht überwiegend durch die vorhandenen Pumpspeicher mit einer Kapazität von 76 GWh und einen kleinen Batteriespeicher mit einer Kapazität von 0,027 GWh.
