...
Der CO\textsubscript{2}-Ausstoß beläuft sich für dieses Berechnungsmodell auf 91,5 Mio. Tonnen. Als einziger Verursacher für den CO\textsubscript{2}-Ausstoß ist die Umwandlung von Methan zu Strom zu nennen, welche bei der Verbrennung CO\textsubscript{2} freisetzt. Ein kostenoptimiertes Energiesystemmodell ohne CO- Reduktionsziel würde einen Ausstoß von 144 Mio. Tonnen erreichen. Somit musste zur Erfüllung des betrachteten Reduktionsziels von 75 \% lediglich 52.5 Mio. Tonnen CO\textsubscript{2} eingespart werden. Dies entspricht einer Verringerung von 14.3 \%. Die Notwendigkeit für den Erdgasimport lässt sich u. a. mit dem hohen Verbrauch durch die Industrie begründen. Auch vorhandene Infrastrukturen erleichtern die Beschaffung zur Deckung des Bedarfs. 
