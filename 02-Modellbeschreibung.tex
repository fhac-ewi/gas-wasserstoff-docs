...
Methan und Biogas können nicht direkt zur Deckung der Strom- bzw. Wasserstoffnachfrage eingesetzt werden, sondern müssen erst diese umgewandelt werden. Dazu können in diesem Modell verschiedene Umwandler genutzt werden, die in dem nachfolgenden Abschnitt beschrieben werden.
...
Zur Energieumwandlung zwischen den Energieträgern werden Umwandlungsanlagen benötigt. So kann beispielsweise durch ein GuD-Kraftwerk Methan in Strom umgewandelt werden. In Tabelle \ref{tab:param-umwandlung-tec} sind die Wirkungsgrade typischer Anlagen und sowie die dabei freigesetzte Menge CO2 ersichtlich. Diese technischen Parameter werden bei der Modellierung berücksichtigt.

\begin{table}[ht!]
    \centering
    \begin{tabular}{|l|cccc|}
        \hline
        \multirow{2}{*}{}        & \multicolumn{2}{c|}{\textbf{Umwandlung}}                              & \multicolumn{1}{c|}{\multirow{2}{*}{\textbf{Wirkungsgrad}}} & \multicolumn{1}{l|}{\multirow{2}{*}{\textbf{CO2 Ausstoß}}} \\
...
Lediglich bei der Verbrennung von Methan wird klimaschädliches CO2 freigesetzt. Für die Erzeugung von 1 GWh elektrischer Energie (Strom) werden 335 Tonnen CO2 freigesetzt. Bei der Verbrennung von Biogas wird auch CO2 freigesetzt, jedoch wurde dieses zuvor von den Pflanzen gebunden. Deshalb ist diese Umwandlung CO2 neutral \cite{bdew43}. 
Bei der Verbrennung von Wasserstoff wird kein CO2 ausgestoßen \cite{bdew42}. 
